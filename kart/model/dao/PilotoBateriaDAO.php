...
" ? )"; // id;
    ...
    public function insertGridInversoPrecedente($bean)
    {
        $dbg = 0;
        try {
            $query = " insert into kart_pilotobateria	" . "		( 	" . "		idpilotobateria,	" . "		idpiloto,	" . "		idbateria,	" . "		criador,	" . "		dtcriacao	" . "		)	" . "	select	" . "		sequenceNextVal('kart_pilotobateria') idpilotobateria,	" . "		pb.idpiloto,	" . "		b.idbateria,	" . "		'script' criador,	" . "		now()   dtcriacao	" . "		" . "	from kart_bateria b	  " . "	inner join kart_pilotobateria pb	  " . "	on pb.idbateria = b.idbateriaprecedente	  " . "	inner join kart_etapa e  " . "	on e.idetapa = b.idetapa  " . "	inner join kart_pilotocampeonato pc  " . "	on pc.idpiloto = pb.idpiloto  " . "	and  pc.idcampeonato = e.idcampeonato  " . "	where b.idbateria = ?   " . "	    and IFNULL(pc.dtvalidade,now()) > NOW() - INTERVAL 1 SECOND    " . " 	    and IFNULL(pc.dtinicio,now()) < NOW() + INTERVAL 1 SECOND    " . "		and not exists(		  " . "			select 1		  " . "			from kart_pilotobateria pbe		   " . "			where pbe.idpiloto = pb.idpiloto	  " . "			and pbe.idbateria = b.idbateria	  " . "		)	  ";
    ...
    public function qualificarGridInversoPrecedente($bean, $ranking)
    {
        $dbg = 0;
        try {
            $query = "	update	" . "		kart_pilotobateria pb	" . "		inner join kart_bateria b	" . "		on b.idbateria = pb.idbateria	" . "		inner join kart_pilotobateria pbant	" . "		on pbant.idpiloto = pb.idpiloto	" . "		and pbant.idbateria = b.idbateriaprecedente		" . "		inner join " . $ranking->gettabelaranking() . " r	" . "		on pbant.idpiloto = r.idpiloto	" . "	set	pb.observacao = 	" . "		concat( 	" . "			lpad(if(pbant.presente='S',pbant.idposicao,0),10,'0') , 	" . "			lpad(r.posicao,10,'0')	" . "		)	" . "	where 	" . "	b.idbateria = " . Util::getIdObjeto($bean->getbateria()) . " 	";
            // " b.idbateria = ? " ;
    ...
    {
        try {
            $query = " insert into kart_pilotobateria	" . "		( 	" . "		idpilotobateria,	" . "		idpiloto,	" . "		idbateria,	" . "		criador,	" . "		dtcriacao	" . "		)	" . "	select	" . "		sequenceNextVal('kart_pilotobateria') idpilotobateria,	" . "	idpiloto,	 " . "	idbateria,	 " . "	criador,	 " . "	dtcriacao " . "	from ( " . "	select	 " . "	pb.idpiloto,	 " . "	b.idbateria,	 " . "	'script' criador,	 " . "	now()   dtcriacao " . "	from kart_bateria b	 " . "	inner join kart_pilotobateria pb	 " . "	on pb.idbateria = b.idbateriaprecedente	 " . "	where b.idbateria = " . Util::getIdObjeto($bean->getbateria()) . " " . "	and pb.idposicao < 19 " . "		and not exists(		" . "			select 1		" . "			from kart_pilotobateria pbe		" . "			where pbe.idpiloto = pb.idpiloto	" . "			and pbe.idbateria = b.idbateria	" . "		)		" . "	union " . "	select	 " . "	pb.idpiloto,	 " . "	b.idbateria, " . "	'script' criador,	 " . "	now()   dtcriacao " . "	from kart_bateria b	 " . "	inner join kart_bateria b2 " . "	on b.idetapa = b2.idetapa " . "	and b.idcategoria = b2.idcategoria " . "	and b.idbateria != b2.idbateria " . "	inner join kart_pilotobateria pb	 " . "	on pb.idbateria = b2.idbateriaprecedente	 " . "	where b.idbateria = " . Util::getIdObjeto($bean->getbateria()) . " " . "	and pb.idposicao < 11 " . "		and not exists(		" . "			select 1		" . "			from kart_pilotobateria pbe		" . "			where pbe.idpiloto = pb.idpiloto	" . "			and pbe.idbateria = b.idbateria	" . "		)		" . "	)	geral ";
    ...
    public function qualificarGridInverso2Precedente1810($bean)
    {
        $dbg = 0;
        try {
            $query = "	update	" . "	kart_pilotobateria pbup	" . "	inner join	" . "	(	" . "	select 	" . "	(	select concat( lpad(30,10,'0') , lpad(pbantB.idposicao,10,'0') ) ordem 	" . "	from kart_pilotobateria pbantB	" . "	where pbantB.idposicao < 11	" . "	and	pbantB.idbateria = boutra.idbateria	" . "	and pbantB.idpiloto = pb.idpiloto	" . "	union	" . "	select concat( lpad(20,10,'0') , lpad(pbantA.idposicao,10,'0') ) ordem 	" . "	from kart_pilotobateria pbantA	" . "	where pbantA.idposicao < 19 	" . "	and pbantA.idbateria = b.idbateriaprecedente	" . "	and pbantA.idpiloto = pb.idpiloto	" . "	) ord	" . "	,pb.idpiloto,p.apelido,pb.idgridlargada,b.idbateriaprecedente,boutra.idbateria,pb.idpilotobateria	" . "	from 	" . "	kart_pilotobateria pb	" . "	inner join kart_bateria b	" . "	on pb.idbateria = b.idbateria		" . "	inner join kart_bateria bprecedete	" . "	on bprecedete.idbateria = b.idbateriaprecedente		" . "	inner join kart_piloto p	" . "	on p.idpiloto = pb.idpiloto	" . "	inner join kart_bateria boutra	" . "	on boutra.idcategoria = b.idcategoria	" . "	and boutra.idetapa = bprecedete.idetapa	" . "	and boutra.idbateria != b.idbateriaprecedente	" . "	where 	" . "	pb.idbateria = " . Util::getIdObjeto($bean->getbateria()) . "	" . "	) pbi	" . "	on pbup.idpilotobateria = pbi.idpilotobateria	" . "	set pbup.observacao = pbi.ord	";
    ...
    {
        try {
            $query = " insert into kart_pilotobateria	" . "		( 	" . "		idpilotobateria,	" . "		idpiloto,	" . "		idbateria,	" . "		criador,	" . "		dtcriacao	" . "		)	" . "	select	" . "		sequenceNextVal('kart_pilotobateria') idpilotobateria,	" . "		idpiloto,	 	" . "		idbateria,	 	" . "		criador,	 	" . "		dtcriacao 	" . "	from ( 	" . "		select	 	" . "			pb.idpiloto,	 	" . "			b.idbateria,	" . "			'script' criador,	 	" . "			now()   dtcriacao 	" . "		from kart_bateria b	 	" . "		inner join kart_pilotobateria pb	 	" . "		on pb.idbateria = b.idbateriaprecedente	 	" . "		where b.idbateria = " . Util::getIdObjeto($bean->getbateria()) . " " . "		and pb.idposicao > 10 	" . "		and not exists(		" . "			select 1		" . "			from kart_pilotobateria pbe		 " . "			where pbe.idpiloto = pb.idpiloto	" . "			and pbe.idbateria = b.idbateria		" . "		)		" . "	union 	" . "		select	 	" . "			pb1.idpiloto,	 	" . "			b1.idbateria, 	" . "			'script' criador,	 	" . "			now()   dtcriacao 	" . "		from kart_bateria b1	" . "		inner join kart_bateria b2 	" . "		on b1.idetapa = b2.idetapa 	" . "		and b1.idcategoria = b2.idcategoria 	" . "		and b1.idbateria != b2.idbateria 	" . "		inner join kart_pilotobateria pb1	 	" . "		on pb1.idbateria = b2.idbateriaprecedente	 	" . "		where b1.idbateria = " . Util::getIdObjeto($bean->getbateria()) . "	" . "		and pb1.idposicao > 18 	" . "		and not exists(		" . "			select 1		" . "			from kart_pilotobateria pbe		 " . "			where pbe.idpiloto = pb1.idpiloto	" . "			and pbe.idbateria = b1.idbateria		" . "		)		" . "			)	geral  ";
    ...
    public function qualificarGridInverso2PioresPrecedente1810($bean, $ranking)
    {
        $dbg = 0;
        try {
            $query = "	update		" . "	kart_pilotobateria pbup		" . "	inner join		" . "	(		" . "	select 		" . "	ifnull(	(select concat( lpad(20,5,'0') , lpad(pbantB.idposicao,5,'0')) ordem 		" . "	from kart_pilotobateria pbantB		" . "	where pbantB.idposicao > 18		" . "	and	pbantB.idbateria = boutra.idbateria		" . "	and pbantB.idpiloto = pb.idpiloto	" . "	and pbantB.presente = 'S'	" . "	union		" . "	select concat( lpad(30,5,'0') , lpad(pbantA.idposicao,5,'0')) ordem 		" . "	from kart_pilotobateria pbantA		" . "	where pbantA.idposicao > 10 		" . "	and pbantA.idbateria = b.idbateriaprecedente		" . "	and pbantA.idpiloto = pb.idpiloto		" . "	and pbantA.presente = 'S')	" . "	,	" . "	(select concat( lpad(10,5,'0') , lpad(k.posicao,5,'0')) ordem	" . "	from " . $ranking->gettabelaranking() . " k	" . "	where k.idpiloto = p.idpiloto)	" . "	) ord		" . "	,pb.idpiloto,p.apelido,pb.idgridlargada,b.idbateriaprecedente,boutra.idbateria,pb.idpilotobateria		" . "	from 		" . "	kart_pilotobateria pb		" . "	inner join kart_bateria b		" . "	on pb.idbateria = b.idbateria			" . "	inner join kart_bateria bprecedete		" . "	on bprecedete.idbateria = b.idbateriaprecedente			" . "	inner join kart_piloto p		" . "	on p.idpiloto = pb.idpiloto		" . "	inner join kart_bateria boutra		" . "	on boutra.idcategoria = b.idcategoria		" . "	and boutra.idetapa = bprecedete.idetapa		" . "	and boutra.idbateria != b.idbateriaprecedente		" . "	where 		" . "	pb.idbateria = " . Util::getIdObjeto($bean->getbateria()) . "	" . "	) pbi		" . "	on pbup.idpilotobateria = pbi.idpilotobateria		" . "	set pbup.observacao = pbi.ord		";
    ...
    public function findPilotoBateria($bean)
    {
        ...
        try {
            ...
            $this->con->setNumero(1, Util::getIdObjeto($bean->getpiloto()));
            $this->con->setNumero(2, Util::getIdObjeto($bean->getbateria()));
            $this->con->setsql($query);
...
" ORDER BY " . $this->ordernome . " "; // sql
    ...
    public function findPilotosEtapa($bean)
    {
        ...
        try {
            ...
            $this->con->setNumero(1, $bean->getbateria()
                ->getetapa()
                ->getid());
            $this->con->setsql($query);
    ...
    public function findBateriaByCampeonatoEtapaBateriaPiloto($idcampeonato, $idetapa, $idbateria, $idpiloto)
    {
        ...
        try {
            ...
            $query = " SELECT " . $this->camposSelect() . ", " . $campeonatoDAO->camposSelect() . ", " . $posicaoDAO->camposSelect() . ", " . $etapaDAO->camposSelect() . ", " . $pilotoDAO->camposSelect() . ", " . $pontuacaoDAO->camposSelect() . ", " . $bateriaDAO->camposSelect() . " FROM " . $this->dbprexis . $this->tabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $pilotoDAO->tabelaAlias() . " ON " . $this->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $bateriaDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idbateria =  " . $bateriaDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $etapaDAO->tabelaAlias() . " ON  " . $bateriaDAO->getalias() . ".idetapa =  " . $etapaDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $campeonatoDAO->tabelaAlias() . " ON  " . $etapaDAO->getalias() . ".idcampeonato =  " . $campeonatoDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $posicaoDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idposicao =  " . $posicaoDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $pontuacaoDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idposicao =  " . $pontuacaoDAO->getalias() . ".idposicao " . " and " . $bateriaDAO->getalias() . ".idpontuacaoesquema =  " . $pontuacaoDAO->getalias() . ".idpontuacaoesquema " . " where " . $campeonatoDAO->idtabelaAlias() . " = IFNULL( ? ," . $campeonatoDAO->idtabelaAlias() . " ) " . " and " . $etapaDAO->idtabelaAlias() . " =   IFNULL( ? ," . $etapaDAO->idtabelaAlias() . " )  " . " and " . $bateriaDAO->idtabelaAlias() . " =   IFNULL( ? ," . $bateriaDAO->idtabelaAlias() . " )  " . " and " . $pilotoDAO->idtabelaAlias() . " =   IFNULL( ? ," . $pilotoDAO->idtabelaAlias() . " )  " . " ORDER BY " . $this->ordernome . " desc";
    ...
    public function findBateriaByCampeonatoEtapaBateriaPilotoNome($idcampeonato, $idetapa, $idbateria, $nome)
    {
        ...
        try {
            ...
            $query = " SELECT " . $this->camposSelect() . ", " . $campeonatoDAO->camposSelect() . ", " . $posicaoDAO->camposSelect() . ", " . $etapaDAO->camposSelect() . ", " . $pilotoDAO->camposSelect() . ", " . $pontuacaoDAO->camposSelect() . ", " . $bateriaDAO->camposSelect() . " FROM " . $this->dbprexis . $this->tabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $pilotoDAO->tabelaAlias() . " ON " . $this->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $bateriaDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idbateria =  " . $bateriaDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $etapaDAO->tabelaAlias() . " ON  " . $bateriaDAO->getalias() . ".idetapa =  " . $etapaDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $campeonatoDAO->tabelaAlias() . " ON  " . $etapaDAO->getalias() . ".idcampeonato =  " . $campeonatoDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $posicaoDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idposicao =  " . $posicaoDAO->idtabelaAlias() . " LEFT JOIN " . $this->getdbprexis() . $pontuacaoDAO->tabelaAlias() . " ON  " . $this->getalias() . ".idposicao =  " . $pontuacaoDAO->getalias() . ".idposicao " . " and " . $bateriaDAO->getalias() . ".idpontuacaoesquema =  " . $pontuacaoDAO->getalias() . ".idpontuacaoesquema " . " where " . $campeonatoDAO->idtabelaAlias() . " = IFNULL( ? ," . $campeonatoDAO->idtabelaAlias() . " ) " . " and " . $etapaDAO->idtabelaAlias() . " =   IFNULL( ? ," . $etapaDAO->idtabelaAlias() . " )  " . " and " . $bateriaDAO->idtabelaAlias() . " =   IFNULL( ? ," . $bateriaDAO->idtabelaAlias() . " )  " . " and " . " 	( " . " lower(" . $pilotoDAO->getalias() . ".nome) =   lower(IFNULL( tiraacento( ? )," . $pilotoDAO->getalias() . ".nome ) ) " . " or lower(" . $pilotoDAO->getalias() . ".apelido) =   lower(IFNULL( tiraacento( ? )," . $pilotoDAO->getalias() . ".apelido) ) " . " or lower(" . $pilotoDAO->getalias() . ".nomejoin) =   lower(IFNULL( tiraacento( ? )," . $pilotoDAO->getalias() . ".nomejoin) ) " . "	) " . " ORDER BY " . $this->ordernome . " desc";
    ...
    public function findPilotoSemBateriaNotBateria($idcampeonato, $idetapa, $idbateria)
    {
        ...
        try {
            ...
            $query = " SELECT distinct " . $pilotoCampeonatoDAO->camposSelect() . ", " . $pilotoDAO->camposSelect() . ",  " . $etapaDAO->camposSelect() . "  " . " FROM " . $this->getdbprexis() . $pilotoCampeonatoDAO->tabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $pilotoDAO->tabelaAlias() . " ON " . $pilotoCampeonatoDAO->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $etapaDAO->tabelaAlias() . " ON  " . $etapaDAO->getalias() . ".idcampeonato =  " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato " . " INNER JOIN " . $this->getdbprexis() . $inscritoDAO->tabelaAlias() . " ON  " . $inscritoDAO->getalias() . ".idpessoa =  " . $pilotoDAO->getalias() . ".idpessoa " . " INNER JOIN " . $this->getdbprexis() . $categoriaInscritoDAO->tabelaAlias() . " ON  " . $categoriaInscritoDAO->getalias() . ".idinscrito =  " . $inscritoDAO->idtabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $categoriaDAO->tabelaAlias() . " ON  " . $categoriaDAO->getalias() . ".idcategoria  =  " . $categoriaInscritoDAO->getalias() . ".idcategoria " . " and " . $categoriaDAO->getalias() . ".idcampeonato =  " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato " . " where " . $pilotoCampeonatoDAO->whereAtivo() . 
            // não esta nesta bateria
            " and not exists( " . " select 1  " . " FROM " . $this->getdbprexis() . $this->tabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $bateriaDAO->tabelaAlias() . " ON " . $bateriaDAO->idtabelaAlias() . " = " . $this->getalias() . ".idbateria " . " INNER JOIN " . $this->getdbprexis() . $inetapaDAO->tabelaAlias() . " ON  " . $inetapaDAO->getalias() . ".idetapa = " . $bateriaDAO->getalias() . ".idetapa " . " WHERE " . $inetapaDAO->getalias() . ".idcampeonato = " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato " . " and " . $this->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . " and " . $inetapaDAO->idtabelaAlias() . " = " . $etapaDAO->idtabelaAlias() . " and " . $bateriaDAO->idtabelaAlias() . " = IFNULL( ? , 0 ) " . " ) " . 
            // / não estar em outra bateria da mesma categoria
            " and not exists( " . " select 1  " . " FROM " . $this->getdbprexis() . $bateriaDAO->tabelaAlias() . " INNER JOIN " . $this->getdbprexis() . $inbateriaDAO->tabelaAlias() . " ON " . $bateriaDAO->getalias() . ".idetapa = " . $inbateriaDAO->getalias() . ".idetapa " . " and " . $bateriaDAO->getalias() . ".idcategoria = " . $inbateriaDAO->getalias() . ".idcategoria " . " INNER JOIN " . $this->getdbprexis() . $this->tabelaAlias() . " ON " . $inbateriaDAO->idtabelaAlias() . " = " . $this->getalias() . ".idbateria " . " INNER JOIN " . $this->getdbprexis() . $inetapaDAO->tabelaAlias() . " ON  " . $inetapaDAO->getalias() . ".idetapa = " . $bateriaDAO->getalias() . ".idetapa " . " WHERE " . $inetapaDAO->getalias() . ".idcampeonato = " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato " . " and " . $this->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . " and " . $inetapaDAO->idtabelaAlias() . " = " . $etapaDAO->idtabelaAlias() . " and " . $inbateriaDAO->getalias() . ".idcategoria " . " = " . $categoriaDAO->idtabelaAlias() . " and " . $bateriaDAO->idtabelaAlias() . " = IFNULL( ? , 0 ) " . " ) " . " and " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato = IFNULL( ? ," . $pilotoCampeonatoDAO->getalias() . ".idcampeonato )  " . " and " . $etapaDAO->idtabelaAlias() . " = IFNULL( ? ," . $etapaDAO->idtabelaAlias() . " )  " . " ORDER BY " . $pilotoDAO->getalias() . ".nome ";
    ...
    public function findPilotoSemBateria($idcampeonato, $idetapa, $idbateria)
    {
        ...
        try {
            ...
            $query = " SELECT distinct " . //sql 
                $pilotoCampeonatoDAO->camposSelect() . ", " . //sql
                $pilotoDAO->camposSelect() . "  " . //sql
                " FROM " . //sql
                $this->getdbprexis() . $pilotoCampeonatoDAO->tabelaAlias() . //sql
                " INNER JOIN " . $this->getdbprexis() . $pilotoDAO->tabelaAlias() . //sql
                " ON " . $pilotoCampeonatoDAO->getalias() . ".idpiloto =  " . $pilotoDAO->idtabelaAlias() . //sql
                " INNER JOIN " . $this->getdbprexis() . $inscritoDAO->tabelaAlias() . //sql
                " ON  " . $inscritoDAO->getalias() . ".idpessoa =  " . $pilotoDAO->getalias() . ".idpessoa " . //sql
                " LEFT JOIN " . $this->getdbprexis() . $categoriaInscritoDAO->tabelaAlias() . //sql
                " ON  " . $categoriaInscritoDAO->getalias() . ".idinscrito =  " . $inscritoDAO->idtabelaAlias() . //sql
                " LEFT JOIN " . $this->getdbprexis() . $categoriaDAO->tabelaAlias() . //sql
                " ON  " . $categoriaDAO->getalias() . ".idcategoria  =  " . $categoriaInscritoDAO->getalias() . ".idcategoria " . //sql
                " and " . $categoriaDAO->getalias() . ".idcampeonato =  " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato " . //sql
                " where " . $pilotoCampeonatoDAO->whereAtivo() . //sql
                " and " . $pilotoCampeonatoDAO->getalias() . ".idcampeonato = IFNULL( ? ," . $pilotoCampeonatoDAO->getalias() . ".idcampeonato )  " . //sql
                " and not exists( " . //sql
                " select 1  " . " FROM " . $this->getdbprexis() . $bateriaDAO->tabelaAlias() . //sql
                " INNER JOIN " . $this->getdbprexis() . $this->tabelaAlias() . //sql
                " ON " . $bateriaDAO->idtabelaAlias() . " = " . $this->getalias() . ".idbateria " . //sql
                " WHERE " . $bateriaDAO->getalias() . ".idetapa = IFNULL( ? ," . $bateriaDAO->getalias() . ".idetapa )  " . //sql
                " and " . $bateriaDAO->idtabelaAlias() . " = IFNULL( ? ," . $bateriaDAO->idtabelaAlias() . "  )  " . //sql
                " and IFNULL(" . $bateriaDAO->getalias() . ".idcategoria,0) = IFNULL(IFNULL(" . $categoriaDAO->getalias() . ".idcategoria , " . $bateriaDAO->getalias() . ".idcategoria  ),0) " . //sql
            ...
            Util::echobr(0, 'PilotoBateriaDAO $this->clt', $this->clt);
        } catch (Exception $e) {
            throw new Exception($e->getMessage());
        }
    ...
    public function maxpregridlargada($bean)
    {
        ...
        try {
            ...
            $query = " SELECT " . // sql
                ...
                " and " . $this->getalias() . ".idbateria =  " . $bateriaDAO->idtabelaAlias() . // sql
                " and " . $bateriaDAO->getalias() . ".idetapa =  " . $etapaDAO->idtabelaAlias() . // sql
                " ORDER BY " .$this->getalias() . ".idpregridlargada desc "; // sql
                
                $this->con->setNumero(1, Util::getIdObjeto($bean->getbateria()));
                $this->con->setsql($query);
                Util::echobr(0, "PilotoBateriaDAO maxpregridlargada", $this->con->getsql());
                $result = $this->con->execute();
                while ($array = $result->fetch_assoc()) {
                    $bean = $this->getBeans($array);
                    $idpregridlargada = $bean->getpregridlargada();
                    $this->result = ($idpregridlargada==null)? 0 : $idpregridlargada;
                    break;
                }
        } catch (Exception $e) {
            throw new Exception($e->getMessage());
    ...
    public function findPilotoCPF( $cpf, $selbateria ){
        ...
        try {
            ...
            $query = " SELECT " .
                ...
                " and " . $pilotoDAO->getalias() . ".cpf = ? " .
                " and " . $this->getalias() . ".idbateria = ? ";
                
                $this->con->setTexto(1, $cpf);
                $this->con->setNumero(2, Util::getIdObjeto($selbateria));
